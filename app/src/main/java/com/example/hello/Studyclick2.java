...
public class Studyclick2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_studyclick2);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent j=new Intent (Studyclick2.this,Main4Activity.class);
                Intent i=new Intent (Studyclick2.this,toto.class);
